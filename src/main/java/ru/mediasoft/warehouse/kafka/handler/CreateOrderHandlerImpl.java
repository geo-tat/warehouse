...
import ru.mediasoft.warehouse.kafka.event.CreateOrderEventDataImpl;
import ru.mediasoft.warehouse.order.dto.OrderDtoIn;
import ru.mediasoft.warehouse.order.service.OrderService;

@RequiredArgsConstructor
@Component
public class CreateOrderHandlerImpl implements EventHandler<CreateOrderEventDataImpl> {
    ...
    @Override
    public String handleEvent(CreateOrderEventDataImpl eventStatus) {
